...
$$Link do Gerador$$
 ...
 (Insira o link do seu site Vercel aqui depois).

Preencha seus dados atuais no painel (Rank, RR atual, Ganho/Perda, Saldo de Vitórias/Derrotas e Último Mapa).

O preview será atualizado instantaneamente.

Clique no botão "Copiar Link" no final da página.
...
Defina a Largura (Width) para 400 e a Altura (Height) para 150.

Clique em OK e posicione a overlay na sua tela!
...
Faça um Fork deste repositório ou faça o upload dos arquivos (index.html e README.md) para um novo repositório no seu GitHub.
...
Nenhuma configuração extra é necessária! Apenas clique em Deploy.
